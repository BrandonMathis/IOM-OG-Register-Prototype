type = ObjectType.create(:g_u_i_d => "52784296-96ee-47cf-800e-fcaac749d5a7",
...
voltage_type = ObjectType.create(:g_u_i_d => "08e90d6e-59c9-4560-95ad-838162b8ce77",
...
data_sheet_group = ObjectType.create(:g_u_i_d => "a62a6cdb-ca56-4b2b-90aa-fafac73bbb7d",
