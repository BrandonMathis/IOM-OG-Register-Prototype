...
class AssetTest < ActiveSupport::TestCase
  ...
  context "destroying an asset" do
    setup do
      ...
      @object_datum1 = Factory.create(:object_datum, :object_type => @type, :eng_unit_type => @unit_type)
      @object_datum2 = Factory.create(:object_datum, :object_type => @type, :eng_unit_type => @unit_type)
      @object_datum3 = Factory.create(:object_datum, :object_type => @type, :eng_unit_type => @unit_type)
      @object_datum4 = Factory.create(:object_datum, :object_type => @type, :eng_unit_type => @unit_type)
